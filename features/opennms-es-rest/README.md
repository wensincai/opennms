...
karaf@root> features:addurl mvn:org.opennms.plugins/opennms-es-rest/19.1.1-TN-SNAPSHOT/xml/features
karaf@root> features:install opennms-es-rest

(or features:install opennms-es-rest/19.1.1-TN-SNAPSHOT for a specific version of the feature)
~~~~
