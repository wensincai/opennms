...
~~~~
karaf@root> features:addurl mvn:org.opennms.plugins/alarm-change-notifier/19.1.1-TN-SNAPSHOT/xml/features
karaf@root> features:install alarm-change-notifier

(or features:install alarm-change-notifier/19.1.1-TN-SNAPSHOT for a specific version of the feature)
~~~~
