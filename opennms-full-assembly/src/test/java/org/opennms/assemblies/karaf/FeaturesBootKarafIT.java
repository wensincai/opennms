...
public class FeaturesBootKarafIT extends OnmsKarafTestCase {
	...
	public void testInstallAllOpenNMSFeatures() {
		addFeaturesUrl(maven().groupId("org.opennms.container").artifactId("org.opennms.container.karaf").version("19.1.1-TN-SNAPSHOT").type("xml").classifier("features").getURL());
		addFeaturesUrl(maven().groupId("org.opennms.karaf").artifactId("opennms").version("19.1.1-TN-SNAPSHOT").type("xml").classifier("features").getURL());
